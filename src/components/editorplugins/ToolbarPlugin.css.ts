...
export const editorText = styleVariants({
    ...
    headingH2: { fontSize: "1.5rem", fontWeight: "bold", marginBottom: "0.75rem" },
    headingH3: { fontSize: "1.25rem", fontWeight: "bold", marginBottom: "0.5rem" },
    headingH4: { fontSize: "1.1rem", fontWeight: "bold", marginBottom: "0.25rem" }
})
